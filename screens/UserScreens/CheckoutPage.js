    ...
    >
      ...
      <View style={{ gap: 8 }}>
        <View style={{ flexDirection: "row", justifyContent: "space-between" }}>
          ...
          <Text style={{ color: "#CB0505", fontSize: 14 }}>Delete All</Text>
        </View>
      ...
      <View style={{ gap: 8 }}>
        ...
        >
          <View style={{ flexDirection: "row", gap: 12 }}>
            <Image source={require("../../assets/Foodmart/phoneIcon.png")} />
        ...
        >
          <View style={{ flexDirection: "row", gap: 12 }}>
            ...
            />
            <Text style={styles.optionText}>Lorem ipsumm lorem ipsum</Text>
          </View>
          <Image />
        </View>
      </View>
