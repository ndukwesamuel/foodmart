...
//   const [progress, setProgress] = useState(55); // Progress percentage (0-100)
...
//     setProgress((prev) => Math.max(prev - 10, 0)); // Decrement by 10% (min 0%)
//   };
//   return (
...
//               borderRightColor: progress >= 50 ? "#0f5132" : "#e9ecef",
//               borderBottomColor: progress >= 75 ? "#0f5132" : "#e9ecef",
//               borderLeftColor: progress === 100 ? "#0f5132" : "#e9ecef",
//             },
//           ]}
//         >
//           <Image
